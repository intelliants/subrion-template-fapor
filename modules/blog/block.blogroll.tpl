{if !empty($block_blog_entries)}
    <div class="blogroll">
        <div class="row">
            {foreach $block_blog_entries as $one_blog_entry}
                <div class="col-md-3">
                    <div class="blog-item" style="background-image: url('{ia_image file=$one_blog_entry.image url=true}')">
                      <div class="blog-item__shadow">
    ...
    <p class="m-t text-center"><a href="{$smarty.const.IA_URL}blog/" class="btn buttons common_btn btn_index text-uppercase">{lang key='view_all_blog_entries'}</a></p>
{else}
